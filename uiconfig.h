...
#define UI_DISPLAY_RS_PIN 46 // PINK.1, 88, D_RS
#define UI_DISPLAY_RW_PIN -1
#define UI_DISPLAY_ENABLE_PIN 47 // PINK.3, 86, D_E
...
void uiInitKeys() {
#if UI_HAS_KEYS != 0
    UI_KEYS_INIT_CLICKENCODER_LOW(50,52); // click encoder on pins 47 and 45.
...
void uiCheckKeys(uint16_t& action) {
    ...
    UI_KEYS_CLICKENCODER_LOW_REV(50,52); // click encoder on pins 47 and 45.
    // Phase is connected with gnd for signals.
